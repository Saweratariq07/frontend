...
const Cart4 = () => {
  const [cart, setCart] = useState ([
    {id:1, name:"Veggie Pizza", price:1500, image:"/Image/p1.png"}
  ]);
          ...
          <div className="absolute top-2 left-2 right-2 flex justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <div className="bg-white p-2 rounded-full shadow-md">
              <button onClick={() => removeFromCart(item.id)}>
                <img src="/Svg/x-solid.svg" alt="Add to cart" className="w-5 h-5" />
              </button>
            </div>
          </div>

          {/* Product Image */}
          <img src="/Image/p1.png" alt="Veggie Pizza" className="w-full h-48 object-cover rounded-lg" />

          {/* Product Info */}
          <h1 className="mt-6 text-gray-700 text-sm">Pizza</h1>
          <h3 className="mt-2 text-lg font-semibold">Veggie Pizza</h3>
