...
const User = () => {
  // Simulated user database (email -> name mapping)
  const usersDatabase = {
    'usman@example.com': 'Usman Bahoo',
      ...
      <div className="container mx-auto px-4 w-full flex justify-center items-center h-screen">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4 mb-4">
            <button
              className="bg-yellow-300 hover:bg-yellow-400 px-6 py-2 rounded-lg font-semibold"
          ...
          <div className='flex justify-center gap-4'>
            ...
            <em className="not-italic text-gray-500">or</em>
            <Link to="/signup" className="text-gray-500">register</Link>
          </div>
        </div>
      </div>
    );
