      ...
      <div>
        <div className="mt-10 container mx-auto my-4 flex flex-col items-center">
         ...
         <div className="border rounded-lg p-4 bg-white shadow-lg w-80 relative group">
            {/* Image */}
            <img src=".\Image\a1.png" alt="Veggie Pizza" className="w-full h-[282px] object-cover rounded-lg" />
            {/* Text Content */}
            <h1 className="mt-6  text-gray-700 text-sm">Drinks</h1>
            <h3 className="mt-6 text-lg font-semibold">Sprite</h3>
            {/* Price and Quantity */}
            <div className="mt-6 flex justify-between items-center">
              <span className="text-xl font-bold text-gray-900">Rs. 90</span>
